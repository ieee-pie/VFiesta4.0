      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Discover hands-on workshops led by industry experts, designed to deepen your knowledge and skills through interactive talk sessions. Join us to explore new technologies, engage in insightful discussions, and connect with fellow enthusiasts.
          </p>
        </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-2xl border border-gray-200 hover:border-primary-600 transition-all duration-300 transform hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  <img
                    src={`/assets/img/workshop${event.id}.jpeg`}
                    alt={event.title}
